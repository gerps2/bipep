...
class Permissoes(models.Model):
    idpermissao = models.AutoField(db_column='idPermissao', primary_key=True, choices=PERMISSOES)  # Field name made lowercase.
    nome = models.CharField(max_length=250, blank=True, null=True)
...
class Usuario(models.Model):
    ...
    idUsuarioDjango = models.ForeignKey(get_user_model(), on_delete=models.CASCADE)
